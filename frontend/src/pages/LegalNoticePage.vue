...
const operatorName = import.meta.env.VITE_OPERATOR_NAME ?? 'FalkenDev'
const operatorCity = import.meta.env.VITE_OPERATOR_CITY ?? 'Sweden'
const operatorCountry = import.meta.env.VITE_OPERATOR_COUNTRY ?? ''
</script>
