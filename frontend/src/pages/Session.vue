<template>
  <div>
    ...
    <div class="my-3 d-flex justify-space-between align-center bg-grey-darken-4 pa-5">
      ...
      <v-btn color="primary">Finnish</v-btn>
    </div>
    <div class="ma-5">
        <v-card
          ...
          <div class="d-flex ga-5 align-center">
            ...
            <div class="d-flex flex-column ga-1">
              ...
              <div class="d-flex ga-2">
                ...
                <v-btn color="primary" @click="startExercise(exercise.exerciseId)">Start</v-btn>
              </div>
            </div>
          </div>
        </v-card>
...
const workoutSession = computed<WorkoutSession | null>(() => workoutSessionStore.selectedWorkoutSession);
